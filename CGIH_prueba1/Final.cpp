...
int main()
{
	...
	Model casaproy("resources/objects/Casaproyecto/house2.obj");
	Model cama("resources/objects/Cama/bed.obj");
	Model cama2("resources/objects/Cama/bed.obj");
	Model cama3("resources/objects/Cama/bed.obj");
	Model cama4("resources/objects/Cama/bed.obj");
	Model cama5("resources/objects/Cama/bed.obj");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Camas
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-30.0f, 2.5f, -40.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		cama.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(-18.0f, 2.5f, -40.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		cama2.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(-6.0f, 2.5f, -40.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-25.0f, 2.5f, -90.0f));
		model = glm::scale(model, glm::vec3(1.0f));
		...
		//Lamparas
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-24.0f, 3.0f, -41.5f));
		model = glm::scale(model, glm::vec3(0.5f));
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		lampara.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 3.0f, -41.5f));
		model = glm::scale(model, glm::vec3(0.5f));
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		//Cocina
		model = glm::translate(glm::mat4(1.0f), glm::vec3(16.0f, 2.5f, -85.0f));
		...
		//Mesa con silla
		model = glm::translate(glm::mat4(1.0f), glm::vec3(32.0f, 2.5f, -85.0f));
		model = glm::scale(model, glm::vec3(0.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		/*
		model = glm::translate(glm::mat4(1.0f), glm::vec3(5.0f, 2.5f, -56.0f));
